...
public class CurrentlyHiredStaffFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_currently_hired_staff_fragment, container, false);
    ...
    private void loadData() {
        paymentRef = FirebaseDatabase.getInstance().getReference()
                .child("AllProfiles").child(Paper.book().read("Phone")).child("CurrentlyHiredStaff");
...
//                            }
                            ...
                            holder.full_layout.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    startActivity(new Intent(getContext(), ShowCurrentlyHiredStaffDetailsActivity.class));
                                }
                            });
