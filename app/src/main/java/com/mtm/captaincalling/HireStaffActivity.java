...
public class HireStaffActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_hire_staff, container, false);
                ...
                ref2.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child("StaffRequestDetails").exists() &&
                                (Objects.equals(snapshot.child("StaffRequestDetails").child("IsStaff").getValue(String.class), "1"))) {
                            ...
                            String phone = snapshot.child("StaffRequestDetails/Pro_phone").getValue(String.class); // Assuming phone number is stored here
...
//                                            });
                                    ...
                                    if(Objects.equals(phone, Paper.book().read("Phone"))) {
                                        ...
                                        startActivity(new Intent(getContext(), HireStaffRequestDetailsActivity.class));
                                    }
                                }
                            });
...
//                            });
            ...
            public AllProfileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hire_staff_model, parent, false);
