...
public class ShowCurrentlyHiredDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_currently_hired_details);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (TextUtils.isEmpty(picture)) {
                    Glide.with(ShowCurrentlyHiredDetailsActivity.this).load(R.drawable.user).into(loadPicture);
                }
                else {
                    Glide.with(ShowCurrentlyHiredDetailsActivity.this).load(picture).into(loadPicture);
                }
        ...
        try {
            ...
            if(endDateObj.before(oneDaysAgo)) {
                ref.child(Paper.book().read("Phone")).child("CurrentlyHiredPro").child(hirerPhoneNo).removeValue();
            }
        }
