...
public class SeeProHiringRequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SeeProHiringRequestsActivity.this);
    ...
    private void loadData() {
        paymentRef = FirebaseDatabase.getInstance().getReference()
                .child("AllProRequestProfiles").child(Paper.book().read("Phone")).child("ProRequestDetails").child("HireProRequests");
        ...
        adapter = new FirebaseRecyclerAdapter<AllProfile, AllProfileViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull AllProfileViewHolder holder, int position, @NonNull AllProfile model) {
                ...
                DatabaseReference ref2 = FirebaseDatabase.getInstance().getReference().child("AllProRequestProfiles").child(Paper.book().read("Phone")).child("ProRequestDetails").child("HireProRequests").child(phoneId);
...
//                                    startActivity(new Intent(getApplicationContext(), HireStaffRequestDetailsActivity.class));
                                    ...
                                    ref2.child("isRequestAccepted").setValue("1")
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Request Accepted", Toast.LENGTH_SHORT).show();

                                                    ref3.child("CurrentlyHiredPro").child(hirerPhoneNo).setValue(HashMap)
                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                @Override
                                                                public void onSuccess(Void unused) {
                                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Added to Currently Hired", Toast.LENGTH_SHORT).show();
                                                                }
                                                            })
                                                            .addOnFailureListener(new OnFailureListener() {
                                                                @Override
                                                                public void onFailure(@NonNull Exception e) {
                                                                    ...
                                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Failed to add to Currently Hired: " + e.getMessage(), Toast.LENGTH_LONG).show();
                                                                }
                                                            });
                                            ...
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Request Accept failed", Toast.LENGTH_SHORT).show();
                                                }
                                            });
...
//                                            });
                                    ...
                                    ref2.child("isRequestAccepted").setValue("-1")
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Request Declined", Toast.LENGTH_SHORT).show();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(SeeProHiringRequestsActivity.this, "Request Decline failed", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            });
