...
public class ProPlayerRequestsActivity extends Fragment {
  ...
  //          WindowManager wm = (WindowManager) getSystemService(WINDOW_SERVICE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_pro_player_requests, container, false);
                ...
                ref2.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child("ProRequestDetails").exists() &&
                                (Objects.equals(snapshot.child("ProRequestDetails").child("IsPro").getValue(String.class), "0"))) {
                            ...
                            String achievements = snapshot.child("ProRequestDetails").child("ProPlayerSport").getValue(String.class);
                                ...
                                public void onClick(View v) {
                                    ...
                                    ref2.child("ProRequestDetails").child("IsPro").setValue("-1")
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    // Handle success
                                                    Toast.makeText(getContext(), "Pro Player request Rejected", Toast.LENGTH_SHORT).show();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    // Handle failure
                                                    Toast.makeText(getContext(), "Failed to reject Pro Player request", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            });
...
//                            });
     ...
     //                       holder.itemView.setLayoutParams(new RecyclerView.LayoutParams(0, 0));
            ...
            public AllProfileViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pro_player_requests_model, parent, false);
